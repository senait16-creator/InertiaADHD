...
const ICONS = {
  ...
  // Hair (js/hair.js and friends) — an experimentation framework, not
  // a tracker. clipboard-check: Hair Routine. history: Wash Log.
  // flask: Experiments. photo: Results Gallery. file-text: Notes &
  // Resources. lock/link: small inline badges within Experiments.
  "clipboard-check": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 11l3 3l8 -8" /><path d="M20 12v6a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2v-12a2 2 0 0 1 2 -2h9" /></svg>`,
  "history": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 8l0 4l2 2" /><path d="M3.05 11a9 9 0 1 1 .5 4m-.5 5v-5h5" /></svg>`,
  "flask": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 3l0 7l-4.5 9a1 1 0 0 0 .9 1.5h13.2a1 1 0 0 0 .9 -1.5l-4.5 -9l0 -7" /><path d="M8.5 14.5l7 0" /><path d="M8 3l8 0" /></svg>`,
  "photo": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 8h.01" /><path d="M6.5 21h11a3.5 3.5 0 0 0 3.5 -3.5v-11a3.5 3.5 0 0 0 -3.5 -3.5h-11a3.5 3.5 0 0 0 -3.5 3.5v11a3.5 3.5 0 0 0 3.5 3.5" /><path d="M3 16l5 -5c.928 -.893 2.072 -.893 3 0l5 5" /><path d="M14 14l1 -1c.928 -.893 2.072 -.893 3 0l3 3" /></svg>`,
  ...
  // Evening Routine's own icon — distinct from Night Routine's
  // moon-star, since the two sit at different points in the evening
  // (see supabase/seed_evening_routine.sql).
  "sunset": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 17h1m16 0h1m-15.4 -6.4l.7 .7m12.1 -.7l-.7 .7m-9.7 5.7a4 4 0 0 1 8 0" /><path d="M3 21l18 0" /><path d="M12 3v6l3 -3m-6 0l3 3" /></svg>`,
